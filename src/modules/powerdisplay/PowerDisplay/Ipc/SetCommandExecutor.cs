...
public static class SetCommandExecutor
{
                ...
                return (null, new CliErrorResult
                {
                    ...
                    Error = new CliError
                    {
                        ...
                        Hint = string.Format(
                            ...
                            "valid settings: {0}",
                            string.Join(", ", MonitorDtoProjector.AllSettingNames)),
                    },
                });
        }
    }
        ...
        CancellationToken ct)
    {
        ...
        {
            return (null, new CliErrorResult { Command = "set", Monitor = monitorRef, Error = rangeError });
        }
        ...
        CancellationToken ct)
    {
        ...
        if (resolved is null)
        {
            return (null, new CliErrorResult { Command = "set", Monitor = monitorRef, Error = valueError! });
        }
        ...
        CancellationToken ct)
    {
        ...
        if (index is null)
        {
            return (null, new CliErrorResult { Command = "set", Monitor = monitorRef, Error = error! });
        }
